// ==UserScript==
// @name         Netroom Extensions ver0.75 β
// @namespace    http://tampermonkey.net/
// @version      0.75
// @description  Netroom Extensions
// @author       NE Team
// @match        https://netroom.oz96.com/*
// @updateURL    https://tanabesan.github.io/netroom_extension/index.user.js
// @downloadURL  https://tanabesan.github.io/netroom_extension/index.user.js
// ==/UserScript==
/*
 *定義系
 */
...
function url_to_a(txt) {
  ...
  if (txt.match(/(www\.youtube\.com\/watch?|youtu\.be\/)/)) {
    newText = txt.replace(regex, (match, url) => {
      ...
      if (y_id == null) {} else {
        ret += `<br><img style="height:120px" src="http://img.youtube.com/vi/${y_id}/hq720.jpg" onclick="open_youtube('https://www.youtube.com/embed/${y_id}')">`
      }
      return ret;
    });
  } else {
